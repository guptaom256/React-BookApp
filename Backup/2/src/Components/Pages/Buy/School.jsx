...
function School(props) {
    ...
    function handleSelectedSubject(subject) {
        // var isFound = false;
        // for (var i = 0; i < selectedSubject.length; i++) {
        //     const element = selectedSubject[i];
        //     if (subject.name === element.name) {
        //         isFound = true;
        //         element.checkedStatus = subject.checkedStatus;
        //         break;
        //     }
        // }
        ...
        // }
        console.log("OM Array: " + JSON.stringify(subject));
        
    }
    const [finalBooksResult, setfinalBooksResult] = useState([]);
    
    // var finalBooksResult1 = [];

    function handleCallbackSchool(book) {
        // console.log(book);
        // console.log("Author: " + JSON.parse(book).authorName);
        // console.log("Checked: " + JSON.parse(book).checkedStatus);
        var isFound = false
        ...
        for (let index = 0; index < finalBooksResult.length; index++) {
            ...
            console.log(JSON.parse(book).subjectName +" === "+ element.subjectName)
    ...
    function handleFinalBook(book) {
        console.log("Om Dopdown Book Sleected : " + JSON.stringify(book));
    }
